...
namespace Erp.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260613110534_AddSecurityPolicy")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Domain.Structure.Cluster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("DataIsolationEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("data_isolation_enabled");
                    ...
                    b.Property<Guid?>("ParentClusterId")
                        .HasColumnType("uuid")
                        .HasColumnName("parent_cluster_id");

                    b.Property<bool>("PermissionInheritanceEnabled")
                        .HasColumnType("boolean")
                        .HasColumnName("permission_inheritance_enabled");
                    ...
                    b.HasIndex("OrganizationId")
                        .HasDatabaseName("ix_clusters_organization_id");

                    b.HasIndex("WorkspaceId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_clusters_workspace_id_code")
                        .HasFilter("is_deleted = false");

                    b.ToTable("clusters", (string)null);
                });

            modelBuilder.Entity("Erp.Domain.Structure.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_departments_workspace_id_code")
                        .HasFilter("is_deleted = false");

                    b.ToTable("departments", (string)null);
                });

            modelBuilder.Entity("Erp.Domain.Structure.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_organizations_workspace_id_code")
                        .HasFilter("is_deleted = false");

                    b.ToTable("organizations", (string)null);
                });

            modelBuilder.Entity("Erp.Domain.Structure.Team", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "Code")
                        .IsUnique()
                        .HasDatabaseName("ix_teams_workspace_id_code")
                        .HasFilter("is_deleted = false");
            ...
            modelBuilder.Entity("Erp.Domain.Structure.Cluster", b =>
                {
                    b.HasOne("Erp.Domain.Structure.Organization", null)
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_clusters_organizations_organization_id");
                });
            ...
            modelBuilder.Entity("Erp.Domain.Structure.Team", b =>
                {
                    b.HasOne("Erp.Domain.Structure.Department", null)
                        .WithMany()
